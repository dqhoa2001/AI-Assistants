                ...
                <div class="w-2/3">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg h-[calc(100vh-8rem)]">
                        <div class="p-6 h-full flex flex-col">
                            <h3 id="chat-title" class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight mb-4">Select a sheet to start chatting</h3>
                                ...
                                <form id="chat-form" class="flex gap-4">
                                    <div class="flex-1 relative">
                                        <textarea 
                                            id="chat-input"
                                            rows="1"
                                            class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500 resize-none overflow-hidden"
                                            placeholder="Type your message..."
                                            disabled
                                        ></textarea>
                                        <div id="markdown-preview" class="hidden absolute left-0 bottom-full w-full mb-2 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg border dark:border-gray-700"></div>
                                    </div>
                                    <button 
                                        type="submit"
